...
def serial_data_postback():
    ...
    ReturnTemp += "#"
    print('serial_data_postback, ReturnTemp    ',ReturnTemp, '    ', len(ReturnTemp))
        ...
        if size == 0:
            ...
            while size != 0:
                ...
                if StartBit == 1 and serialdatabit == '#':
                    ...
                    StartBit = 0
                    size = 0
                    print('serialEvent, InputString      ',InputString)

global ser
try:
    ser = serial.Serial("/dev/ttyAMA0", 9600, timeout = 0.001, write_timeout= 0.01)
